...
class Ventana(QMainWindow):
    ...
    def __init__(self):
        ...
        hBoxLayout = QtWidgets.QHBoxLayout(self.widget_AutoScaleY_FMCW_triangle_DualRate_1)
        ...
        win_CW = pg.QtWidgets.QMainWindow()
        ...
        win_FMCW_sawtooth = pg.QtWidgets.QMainWindow()
        MyView = pg.GraphicsLayoutWidget()
        ...
        win_FMCW_triangle = pg.QtWidgets.QMainWindow()
        MyView = pg.GraphicsLayoutWidget()
        ...
        win_FMCW_triangle_DualRate_1 = pg.QtWidgets.QMainWindow()
        MyView = pg.GraphicsLayoutWidget()
        ...
        win_FMCW_triangle_DualRate_2 = pg.QtWidgets.QMainWindow()
        MyView = pg.GraphicsLayoutWidget()
